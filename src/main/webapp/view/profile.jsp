...
<body>
  ...
  <form class="edit-profile-form" onsubmit="saveProfile(event)">
    ...
    <p id="saveMessage" class="save-message">Profile updated successfully!</p>
  </form>
</div>
    ...
    <div class="tab-content" id="favorites">
      <div class="movie-card">
        <img src="https://image.tmdb.org/t/p/w500/or06FN3Dka5tukK1e9sl16pB3iy.jpg" alt="Stranger Things">
  ...
  function saveProfile(event) {
    ...
    // Optional: Hide message after 2 seconds and go back to view mode
    setTimeout(() => {
